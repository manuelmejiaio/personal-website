<template>
  <div id="blog" class="flex flex-col items-center text-green-700 pt-10 pb-20 px-5">
    ...
    <a class="text-2xl text-green-700 hover:text-green-900" rel="noopener" href="/blog">
      MORE POSTS...
    </a>
  </div>
</template>
      ...
      blogPosts: [
        {
          ...
          link: `/blog/2020/08/lets-talk-about-web-accessibility`,
        ...
        },
        {
          ...
          link: `/blog/2018/07/clean-code-even-under-pressure`,
        ...
        },
        {
          ...
          link: `/blog/2017/09/improve-your-skills-as-developer-with`,
        ...
        },
        {
          ...
          link: `/blog/2018/01/material-design-guidelinesthe-lighthouse`,
